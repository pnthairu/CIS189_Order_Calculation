...
"""
import unittest
from store import test_price_under_between_thirty_fifty_calc


class MyTestCase(unittest.TestCase):
    def test_something(self):
        self.assertEqual(test_price_under_between_thirty_fifty_calc.calculate_price(55.06), 55, 10, 30)
