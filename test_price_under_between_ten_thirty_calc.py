...
if __name__ == '__main__':
    """
price: under 30 and more than 10, 5 cash, 10%
price: under 30 and more than 10, 5 cash, 15%
price: under 30 and more than 10, 5 cash, 20%
price: under 30 and more than 10, 10cash, 10%
price: under 30 and more than 10,  10 cash, 15%
price: under 30 and moe than 10, 10 cash, 20%
"""
purchase_price = float(input("Please enter the purchase price: "))
# Condition to check if the price is below 10 dollars
if purchase_price < 10 or purchase_price > 30:
    print("BECAUSE YOUR PURCHASE PRICE IS LESS '$10' or more than '$30' YOU GET NO DISCOUNTS. 'SORRY'!!!")
