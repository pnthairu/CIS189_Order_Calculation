...
if __name__ == '__main__':
    """
price: under 50 and more than 30, 5 cash, 10%
price: under 50 and more than 30, 5 cash, 15%
price: under 50 and more than 30, 5 cash, 20%
price: under 50 and more than 30,  10 cash, 10%
price: under 50 and more than 30, 10 cash, 15%
price: under 50 and more than 30, 10 cash, 20%
"""
purchase_price = float(input("Please enter the purchase price: "))
# Condition to check if the price is below 10 dollars
if purchase_price < 30 or purchase_price > 50:
    print("BECAUSE YOUR PURCHASE PRICE IS LESS '$30' or more than '$50' YOU GET NO DISCOUNTS. 'SORRY'!!!")
...
# purchase_price = float(input("Please enter the purchase price: "))
    ...
    if cash_off_coupon == 5.00:
        if percentage_discount == 10:
            ...
            add_shipping_cost = price_after_all_discount + TEN_THIRTY_SHIPPING_COST
...
print("Price after adding '5.95' shipping cost: $" + str(add_shipping_cost))
