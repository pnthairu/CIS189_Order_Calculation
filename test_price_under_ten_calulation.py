...
for item price which is between 1 and 10 dollars.
...
price: under 10, 10 cash, 30%
"""
purchase_price = float(input("Please enter the purchase price: "))
# Condition to check if the price is below 10 dollars
if purchase_price < 1 or purchase_price > 10:
    print("BECAUSE YOUR PURCHASE PRICE IS LESS '$1' or more than '$10' YOU GET NO DISCOUNTS. 'SORRY'!!!")
